...
public class JPasswordField extends javax.swing.JPasswordField {
    ...
    public JPasswordField(String hint, int radius) {
        super();
        this.radius = radius;
        this.hint = hint;
        ...
        setOpaque(false);
        setText(hint);
        setEchoChar((char)0); // Initially show hint text
        ...
        addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                if (String.valueOf(getPassword()).equals(hint)) {
                    setText("");
                    setEchoChar('•');  // Set password character
    ...
    public boolean isEmpty() {
        return String.valueOf(getPassword()).equals(hint) || 
